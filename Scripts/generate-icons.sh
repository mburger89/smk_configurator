...
render_svg_icon "$FLUENT_BASE/Wand/SVG/ic_fluent_wand_24_regular.svg" "$RAIL_SIZE" "$ICON_ROOT/Windows/Icons/light/macros.png" "$ICON_ROOT/Windows/Icons/dark/macros.png"
...
render_svg_icon "$ADWAITA_BASE/categories/applications-utilities-symbolic.svg" "$RAIL_SIZE" "$ICON_ROOT/Linux/Icons/light/macros.png" "$ICON_ROOT/Linux/Icons/dark/macros.png"
